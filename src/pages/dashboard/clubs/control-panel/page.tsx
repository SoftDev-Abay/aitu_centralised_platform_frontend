...
const ClubControlPanelDashboardPage = () => {
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-5">
        ...
        <QuickLinkCard
          ...
          url={`/control-panel/clubs/view/${clubId}/events`}
        ...
        <QuickLinkCard
          ...
          title="Members"
          subtitle="Quick links"
          url={`/control-panel/clubs/view/${clubId}/members`}
          className="py-6 border shadow-sm rounded-xl"
        />
        <QuickLinkCard
          icon={<StarIcon />}
          ...
          title="Applications"
          subtitle="Quick links"
          url={`/control-panel/clubs/view/${clubId}/applications`}
          className="py-6 border shadow-sm rounded-xl"
        />
        {/* <QuickLinkCard
          icon={<StarIcon />}
...
export default ClubControlPanelDashboardPage;
